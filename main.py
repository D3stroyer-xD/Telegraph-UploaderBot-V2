...
👨‍💻 **Developer :** [Toxic](https://github.com/Itz_ToxicBoy_xD)

📢 **Channel :** [Altronix Bots](https://telegram.me/AltronixBots)

👥 **Group :** [AltronixSupport](https://telegram.me/AltronixSupport)

🌐 **Source :** [👉 Click here](https://github.com/D3stroyer-xD/Telegraph-UploaderBot-V2)
    ...
    if UPDATE_CHANNEL:
        try:
		  ...
		  reply_markup=InlineKeyboardMarkup(
            ...
            print(error)
            await update.reply_text(text="Something wrong. Contact <a href='https://telegram.me/Itz_ToxicBoy_xD'>Developer</a>.", disable_web_page_preview=True)
            return
    ...
    await text.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(text="⚙ Join Updates Channel ⚙", url="https://telegram.me/AltronixBots")]
            ]
        )
    )
